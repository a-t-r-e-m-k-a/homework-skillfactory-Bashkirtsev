...
SECRET_KEY = 'django-insecure-#nuvi0d+&es7&xyj5a#(h)=+)+jfjdnn_h022jtcqe*2@8m8-r'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'NewsPortal50'
EMAIL_HOST_PASSWORD = 'bluefitmfehorbrq'
EMAIL_USE_SSL = True
DEFAULT_FROM_EMAIL = 'NewsPortal50@yandex.ru'
