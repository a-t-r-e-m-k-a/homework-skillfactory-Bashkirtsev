...
class Player:
    ...
    def __init__(self, board, enemy, life=True):
        self.board = board
        self.enemy = enemy
        self.life = life
    ...
    def move(self):
        while True:
            try:
                target = self.ask()
                repeat = self.enemy.shot(target, self.life)
                return repeat
